...
const Footer = () => {
  return (
    <footer className="bg-gray-900 text-white py-6">
      <div className="max-w-screen-2xl px-4 mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <div>
          <h2 className="text-2xl font-bold text-secondary mb-6">Quick Links</h2>
          <ul className="space-y-4 text-gray-300">
            <li>
              <a
                href="/about"
          ...
          <h2 className="text-xl text-secondary font-bold mt-8 mb-4">Follow Us</h2>
        ...
        <div>
          <h2 className="text-2xl text-secondary font-bold mb-6">Stay Informed</h2>
          ...
          <form className="flex flex-col sm:flex-row items-stretch">
            ...
            />
            <button
              className="bg-primary text-gray-900 px-4 py-2 rounded-b-md sm:rounded-r-md sm:rounded-b-none hover:bg-secondary transition duration-200">
              Subscribe
            </button>
          </form>
        </div>
